          ...
          <section>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex flex-col items-center px-3 py-2.5 rounded-xl bg-brand-700 hover:bg-brand-800 text-white text-sm font-semibold transition-colors"
              >
                <span className="text-xs opacity-80">Mensual</span>
                <span>$3.500 ☕</span>
              </button>
              <button
                onClick={() => { onClose(); onDonate('anual'); }}
                className="flex-1 flex flex-col items-center px-3 py-2.5 rounded-xl bg-brand-800 hover:bg-brand-900 text-white text-sm font-semibold transition-colors ring-1 ring-brand-400 dark:ring-brand-500"
              >
                <span className="text-xs opacity-80">Anual ✦</span>
                <span>$28.000</span>
              </button>
            </div>
            <p className="text-xs text-slate-400 dark:text-slate-500 mt-1.5 text-center">
              El plan anual silencia el aviso por 12 meses
            </p>
          </section>
