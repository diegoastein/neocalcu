...
**Campo email del cupón:** dejarlo libre para que el residente ingrese su propio email. Le permite recuperar su cuenta si cambia de dispositivo vía `/recuperar`. No usarlo para notas internas.
